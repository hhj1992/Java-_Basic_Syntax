...
<body>
    <div id="wrap">
        <form  method="post" action="../jsp/updateUser.jsp">
            <table id="table_box">
                <tr>
                    <td>* 개인정보</td>
                ...
                <tr>
                    ...
                    <td colspan="3"> <input name="id" type="text" value="<%=vo.getId()%>" readonly="readonly"></td>
                </tr>
                <tr>
                    <td class="row_title">* 비밀번호</td>
                    <td colspan="3"> <input name="password" type="password" value="<%=vo.getPassword()%>"></td>
                </tr>
                <tr>
                    <td class="row_title">* 이름(한글실명)</td>
                    <td colspan="3"> <input name="name" type="text" value="<%=vo.getName()%>" readonly="readonly"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input type="text" name="year" value="<%=vo.getYear()%>">년
